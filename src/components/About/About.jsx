    ...
    return <section>
        <motion.div
            ...
            <div className={style.info}>
                ...
                <motion.p custom={2} variants={animation}>Я мотивированный и постоянно развивающийся fullStack-разработчик. Не стесняйтесь заглянуть в мое портфолио, чтобы ознакомиться с разнообразными проектами, которые я завершила. Если Вас заинтересовала моя работа и Вы хотите, чтобы я воплотила Ваш проект в жизнь, не стесняйтесь связаться со мной!</motion.p>
